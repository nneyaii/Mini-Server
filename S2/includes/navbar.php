<?php
// $activePage: 'home', 'topics-listing', 'contact'
            ...
            <ul class="navbar-nav ms-lg-5 me-lg-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                        <li>
                            <a class="dropdown-item <?php echo ($activePage === 'topics-listing') ? 'active' : ''; ?>"
                                href="topics-listing.php">Topics Listing</a>
                        </li>
                        <li>
                            <a class="dropdown-item <?php echo ($activePage === 'contact') ? 'active' : ''; ?>"
