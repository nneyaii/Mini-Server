            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-5 col-12 subscribe-form-wrap d-flex justify-content-center align-items-center">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['subscribe-email'])) {
                        $email = filter_var(trim($_POST['subscribe-email']), FILTER_VALIDATE_EMAIL);
                        if ($email) {
                            // Proses subscribe di sini (misal: simpan ke database / kirim email)
                    ...
                    <?php else: ?>
                    <form class="custom-form subscribe-form" action="topics-detail.php" method="post" role="form">
                        <h4 class="mb-4 pb-2">Get Newsletter</h4>

                        <?php if ($subscribeError): ?>
                        <div class="alert alert-danger"><?php echo htmlspecialchars($subscribeError); ?></div>
                        <?php endif; ?>
